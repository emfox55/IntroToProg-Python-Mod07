...
#   EFox,11/26/2024,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    def student_last_name(self):
        return self.student_last_name.title()
...
class Student(Person):
    """
       ...
       Properties:
           student_first_name (str): The student's first name.
           student_last_name (str): The student's last name.
           course_name (str): The course of the student.
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        EFox,11/26/2024,Created function
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        try:
            ...
            for student in student_data:  # Convert List of Student objects to list of dictionary rows.
                student_json: dict \
                    = {"FirstName": student.student_first_name, "LastName": student.student_last_name, "CourseName": student.course_name}
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            student.course_name = float(input("What is the student's course name? "))
